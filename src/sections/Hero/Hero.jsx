  ...
  return (
    <section className=" md:px-[72px] xl:px-[194px] translate-y-[-15px] md:h-[373px] xl:h-[603px] relative flex flex-col mx-2 md:mx-4 items-center bg-heroBg rounded-b-xl">
      <div className=" w-full xl:pt-[123px] xl:pb-[206px] md:self-start md:text-left text-center md:pt-[84px] md:pb-[123px]">
        ...
        <p className=" xl:text-[164px] xl:leading-[164px] xl:tracking-normal md:flex md:justify-between md:text-[92px] md:leading-[92px] md:tracking-[0.92px] mb-2 md:mb-4 xl:mb-[30px] text-primaryColor text-[44px] font-black font-grotesk leading-[44px] tracking-[0.44px]">
          <span>YACHT</span>
          <span>APES</span>
        </p>
      ...
      <Image
        className=" block mx-auto w-[216px] h-[284px] md:absolute md:top-[-13px] xl:top-[-9px] md:w-[283px] md:h-[386px] xl:w-[463px] xl:h-[612px] md:left-[206px] xl:left-[445px] "
        src="/hero_mobil.png"
        alt="img"
        width={463}
        height={612}
